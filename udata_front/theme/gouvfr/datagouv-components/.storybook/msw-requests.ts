    ...
    http.get('*/api/1/datasets/frequencies/*', async () => {
      ...
      return HttpResponse.json(
        [
          ...
          { "id": "continuous", "label": "tempo real" },
          { "id": "hourly", "label": "por hora" },
          { "id": "fourTimesADay", "label": "quatro vezes por dia" },
          { "id": "threeTimesADay", "label": "três vezes por dia" },
          { "id": "semidaily", "label": "semidiário" },
          { "id": "daily", "label": "diário" },
          { "id": "fourTimesAWeek", "label": "quatro vezes por semana" },
          { "id": "threeTimesAWeek", "label": "três vezes por semana" },
          { "id": "semiweekly", "label": "semisemanal" },
          { "id": "weekly", "label": "semanal" },
          { "id": "biweekly", "label": "quinzenal" },
          { "id": "threeTimesAMonth", "label": "três vezes por mês" },
          { "id": "semimonthly", "label": "semestralmente" },
          { "id": "monthly", "label": "mensal" },
          { "id": "bimonthly", "label": "bimestral" },
          { "id": "quarterly", "label": "trimestral" },
          { "id": "threeTimesAYear", "label": "três vezes por ano" },
          { "id": "semiannual", "label": "semianual" },
          { "id": "annual", "label": "anual" },
          { "id": "biennial", "label": "bienal" },
          { "id": "triennial", "label": "trienal" },
          { "id": "quinquennial", "label": "quinquenal" },
